...
class _ResultPageState extends State<ResultPage> {
          ...
          child: Center(
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text('Tangalarni joylashtirish, Munchoqlarni ipga tizish, Drawing Trail',textAlign: TextAlign.center,),
                SizedBox(height: 5,),
                DataTable(
                  columnSpacing: 20,
                  decoration: BoxDecoration(
                  ...
                  rows:[
                    DataRow(cells: [
                      DataCell(
                        SizedBox(
                          child: Wrap(
                            children: [Text("${widget.answerList[0]+widget.answerList[1]+widget.answerList[2]}")],
                          ),
                        ),
                      ),
                      DataCell(
                        Center(child: Text(((componentList[0]*10).truncate()/10).toString())),
                      ),
                      DataCell(
                        Center(child: Text(((percentileList[0]*10).truncate()/10).toString())),
                      ),
                    ]),
                  ],
                ),
                SizedBox(height: 20),
                Text(groupQuestionList[1],textAlign: TextAlign.center,),
                SizedBox(height: 5,),
                DataTable(
                  columnSpacing: 20,
                  decoration: BoxDecoration(
                  ...
                  rows:[
                    DataRow(cells: [
                      DataCell(
                        SizedBox(
                          child: Wrap(
                            children: [Text("${widget.answerList[3]+widget.answerList[4]+widget.answerList[5]}")],
                          ),
                        ),
                      ),
                      DataCell(
                        Center(child: Text(((componentList[1]*10).truncate()/10).toString())),
                      ),
                      DataCell(
                        Center(child: Text(((percentileList[1]*10).truncate()/10).toString())),
                      ),
                    ]),
                  ],
                ),
                SizedBox(height: 20),
                Text(groupQuestionList[2],textAlign: TextAlign.center,),
                SizedBox(height: 5,),
                DataTable(
                  columnSpacing: 20,
                  decoration: BoxDecoration(
                  ...
                  rows:[
                    DataRow(cells: [
                      DataCell(
                        SizedBox(
                          child: Wrap(
                            children: [Text("${widget.answerList[6]+widget.answerList[7]+widget.answerList[8]+widget.answerList[9]}")],
                          ),
                        ),
                      ),
                      DataCell(
                        Center(child: Text(((componentList[2]*10).truncate()/10).toString())),
                      ),
                      DataCell(
                        Center(child: Text(((percentileList[2]*10).truncate()/10).toString())),
                      ),
                    ]),
                  ],
                ),
                SizedBox(height: 20),
                Text('Testning umumiy natijasi',textAlign: TextAlign.center,style: TextStyle(fontWeight: FontWeight.bold,fontSize: 18),),
                SizedBox(height: 5,),
                DataTable(
                  columnSpacing: 20,
                  decoration: BoxDecoration(
                  ...
                  rows:[
                    DataRow(cells: [
                      DataCell(
                        SizedBox(
                          child: Wrap(
                            children: [Text("$totalScore")],
                          ),
                        ),
                      ),
                      DataCell(
                        Center(child: Text(((componentScore*10).truncate()/10).toString())),
                      ),
                      DataCell(
                        Center(child: Text((getPercentileScore(componentScore)*10.truncate()/10).toString())),
                      ),
                    ]),
                  ],
                ),
  ...
  void checkScore(List scoreList) {
    ...
    componentList.add((scoreList[0] + scoreList[1] + scoreList[2] + scoreList[3]) / 4);
    componentList.add((scoreList[4] + scoreList[5]) / 2);
    componentList.add((scoreList[6] + scoreList[7] + scoreList[8] + scoreList[9]) / 4);
